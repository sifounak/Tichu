...
4. **Special card rules** — Never pass Dragon/Phoenix/Mahjong to opponents. If your partner has called Grand Tichu or Tichu and you have a reliable way to take control back (Dragon, Ace, bomb, or three Kings), keep Dog so you can later transfer the lead to partner. Also keep Dog from a weak support hand when you pass partner a strong card and still retain reliable control, so you can feed partner if they call Tichu later. If an opponent has called Grand Tichu or Tichu before the pass, give Dog to that opponent. Dog goes to partner if you have a strong hand, but may need help regaining control of trick if you lose it. Otherwise, pass Dog to the right if you have a strong hand, pass Dog to the left if you have a weak hand.
