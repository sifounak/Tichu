...
|--------|-------------|-----------|---------------|--------------|--------|
| REQ-F-GA01 | Room name click copies game URL | M3 | | | Not Started |
| REQ-F-GA02 | "Link copied!" toast (2s) | M3 | | | Not Started |
| REQ-F-GA03 | Room name hover hint (underline/icon) | M3 | | | Not Started |
| REQ-F-GA04 | Room Code display removed | M3 | | | Not Started |
| REQ-F-GA05 | Spectators: # display | M3 | | | Not Started |
| REQ-F-GA06 | Spectator names tooltip/tap | M3 | | | Not Started |
| REQ-F-GA07 | Kebab (⋮) button for all users | M2 | | | Not Started |
| REQ-F-GA08 | Desktop popover dropdown | M2 | | | Not Started |
| REQ-F-GA09 | Mobile slide-in drawer | M2 | | | Not Started |
| REQ-F-GA10 | Menu dismiss (Escape/click-outside/select) | M2 | | | Not Started |
| REQ-F-GA11 | Menu disabled during active vote | M5 | | | Not Started |
| REQ-F-GA12 | Pre-game menu items | M2 | | | Not Started |
| REQ-F-GA13 | Kick Player target selection (pre-game) | M3 | | | Not Started |
| REQ-F-GA14 | In-game menu items | M2 | | | Not Started |
...
| REQ-F-GA18 | Non-host dialog: Cancel + Start Vote | M2 | | | Not Started |
| REQ-F-GA19 | Start Vote sends correct message type | M3/M4 | | | Not Started |
| REQ-F-GA20 | Host dialog: Cancel + Start Vote + Force | M2 | | | Not Started |
| REQ-F-GA21 | Force button destructive styling | M2 | | | Not Started |
| REQ-F-GA22 | Start Vote is primary button | M2 | | | Not Started |
| REQ-F-GA23 | Force sends force message | M4 | | | Not Started |
| REQ-F-GA24 | Transfer Host visible to host only | M2 | | | Not Started |
...
| REQ-F-GA42 | Opening kebab cancels target selection | M3 | | | Not Started |
...
| REQ-F-GA45 | Cancel Vote button replaces kebab | M5 | | | Not Started |
| REQ-F-GA46 | Host toggle voting | M2 | | | Not Started |
| REQ-F-GA47 | Voting disabled: items greyed with hint | M5 | | | Not Started |
...
| REQ-NF-GA01 | Menu opens instantly (desktop) | M2 | | | Not Started |
| REQ-NF-GA02 | Drawer 200ms slide transition | M2 | | | Not Started |
