...
- Source (M13-M14): `specifications/2026-03-27-expert-bot-partner-support.md`
- Plan (M1-M4): `plans/tranquil-twirling-wreath.md` (`.claude/plans/`)
- Plan (M5-M7): `plans/2026-03-27-expert-bot-partner-support.md`
...
| REQ-F-DEF01 | Prefer Aces as singletons | M2 | 4 | expert-bot.ts:chooseLeadPlay | expert-bot.test.ts | Passed |
| REQ-F-DEF02 | Prefer Aces late in round | M2 | 4 | expert-bot.ts:chooseLeadPlay | expert-bot.test.ts | Passed |
| REQ-F-DEF03 | Aces only for control or disruption | M2 | 4 | expert-bot.ts:chooseLeadPlay | expert-bot.test.ts | Passed |
| REQ-F-DEF04 | Prefer multi-card hands over breaking combos | M2 | 4 | expert-bot.ts:chooseLeadPlay | expert-bot.test.ts | Passed |
| REQ-F-DEF05 | Low-to-high rank order | M2 | 4 | bot-strategy-utils.ts:rankCombinationsForLead | bot-strategy-utils.test.ts | Passed |
| REQ-F-DEF06 | Control probability for low multi-card leads | M2 | 4 | expert-bot.ts:chooseLeadPlay | expert-bot.test.ts | Passed |
